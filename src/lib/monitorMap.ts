...
export const PROJECTS: ProjectMeta[] = [
  ...
  },
  {
    ...
    description: "Spotify event-driven con caché y métricas async.",
    tags: ["Java 21", "Spring Boot", "Oracle 23c", "Redis", "Kafka"],
    liveUrl: "https://playsomething.plop.blog",
    githubUrl: "https://github.com/bulletformyvalentinefan/play-something",
    kumaId: "3",
    arch: [
      { label: "React 19", sublabel: "Vite" },
      { label: "Spring Boot", sublabel: "Deezer · TTL 1h" },
      { label: "Redis", sublabel: "Cache" },
      { label: "Oracle 23c", sublabel: "Kafka metrics" },
    ],
  },
  {
    id: "auto-deploy",
